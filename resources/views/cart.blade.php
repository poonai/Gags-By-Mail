                                    ...
                                    <tbody>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                <a href="single-product.html"><img width="145" height="145" alt="poster_1_up" class="shop_thumbnail" src="{{$data[$i-1]->url}}"></a>
                                            </td>

                                            <td class="product-name">
                                                <a href="single-product.html">{{$data[$i-1]->name}}</a>
                                            </td>

                                            <td class="product-price">
                                                <span class="amount">{{$data[$i-1]->price}}</span>
                                            </td>
